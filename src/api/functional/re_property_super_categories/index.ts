...
export function getList
    (
        ...
        query: IREPropertyCategory.ISuper.ISearch
...
{
    export type Query = IREPropertyCategory.ISuper.ISearch;
    ...
    export function path(query: IREPropertyCategory.ISuper.ISearch): string
    {
