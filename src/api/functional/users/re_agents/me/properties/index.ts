 ...
 * @throw 403 Forbidden
 * 
 * @controller REAgentsController.getMyPropertyList()
 * @path GET /users/re-agents/me/properties
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
export function getMyPropertyList
    (
        connection: IConnection,
        query: IREAgent.IProperty.ISearch
    ): Promise<getMyPropertyList.Output>
{
    return Fetcher.fetch
    (
        connection,
        getMyPropertyList.ENCRYPTED,
        getMyPropertyList.METHOD,
        getMyPropertyList.path(query)
    );
}
export namespace getMyPropertyList
{
