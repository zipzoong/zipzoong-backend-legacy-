 ...
 * @module api.functional.expert_super_categories.expert_sub_categories
 ...
 * @path GET /expert-super-categories/:super_id/expert-sub-categories
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace getList
{
    ...
    export const PATH: string = "/expert-super-categories/:super_id/expert-sub-categories";
    ...
    {
        return `/expert-super-categories/${encodeURIComponent(super_id ?? "null")}/expert-sub-categories`;
    }
}